...
export default class Labelbox extends Component {
	...
	changeGender = (data) => {
		...
		this.props.changeDealOption && this.props.changeDealOption(data);
	}
	...
	componentWillReceiveProps(props) {
		...
		if (props.dealOption) {
			this.setState({ gender: props.dealOption });
		}
	}
	onChange = (time) => {
		...
		if (data.type == 'text') {
			return (
				<div className="formdiv">
					<label className="labeltxt">{data.labelname} {this.props.required && <span className="text-danger">*</span>}</label>
					<div>

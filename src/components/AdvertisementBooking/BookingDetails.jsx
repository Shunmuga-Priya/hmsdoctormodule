...
cancel = () => {
    ...
    insertAdBooking = (details) => {
        ...
        Axios({
            ...
            this.generateAlert("Advertisement Booked Successfully");
            this.getAdBooking()
            this.cancel()
    ...
    editAdBooking = (details) => {
        ...
        Axios({
            ...
            this.generateAlert("Advertisement Updated Successfully");
            this.getAdBooking()
        }).catch((error) => {
            alert(JSON.stringify(error))
        })
...
//   get the ad details
  ...
  placementLocation = () => {
      ...
      for(let i=0;i<this.state.placementLocation.length;i++){
            locations.push(<option key={i+1} onChange={this.click} value={this.state.placementLocation[i].adlocationId}>{this.state.placementLocation[i].placement_location}</option>)
      }
                    ...
                    <Tabs defaultActiveKey="1"   activeKey={this.state.activeKey} onChange={this.callback}>
                        <TabPane tab="Create Ad" key="1"> 
                                ...
                                
                            {
                                this.state.sizeData.length > 0 && this.state.sizeData.map(checkingsize =>
                                    ...
                                    <input type="number" className="html__input" value={this.state.adfeeperday} onChange={(e) => this.changeData(e,'fee')}></input>
                                    </div>
                                ...
                                <Grid item xs={12} md={6} className="create_container">
                                    ...
                                    changeData={(data) => this.datepickerChange(data,'enddate')} value={this.state.endDate}/>
                                ...
                                <label className="location_label">Placement Location</label>
                                    <select className="select_location"  onChange={(e) => this.changeData(e,'location')} 
                                ...
                                <Grid item xs={12} md={12} className="create_container">
                                    ...
                                    <span><FiInfo className="info_icon" onClick={this.handleOpen}/></span>
                                        ...
                                        <Upload 
                                            ...
                                            <span>{this.state.imageName === "" ? "My image.jpg" : this.state.imageName}</span>
                                ...
                                <Grid item xs={12} md={12} className="create_container">
                                    <div className="datebook_container">
                                        <Button className="datebook_button" onClick={this.handleSubmit} component = {NavLink} to= "/Home/Cancelpayment"
                        ...
                        <TabPane tab="Ad List" key="2">
                            <AdvertiseList
                             ...
                             generateAlert = {(msg) => this.generateAlert(msg)}
                               />
                        </TabPane>
                    </Tabs>
                <div></div>

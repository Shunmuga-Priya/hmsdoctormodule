    ...
    return(
       <div className="location_add_container">
           <Grid container className="Ad_location_container">
               ...
               <Grid item xs={4} md={2}>
                  <div className="phone_icon"> <img src={Half}/></div>
                  <p className="full_half_textedit">Full</p>
                  <div className="icon_editing">
                   <img src={Workflow} className="listdelete_icon" onClick={this.flowOpen}/>
                   <h3 className="edit_icon"> <MdModeEdit /> </h3>
                   <DeleteIcon className="listdelete_icon" onClick={this.handleOpen}/>
                   </div>

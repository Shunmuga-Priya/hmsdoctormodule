    ...
    handleChange = info => {
      ...
      const { classes, onClose, cancel, selectedValue, ...other } = this.props;
          ...
          return(
            <>
              {/* <div> */}
                  {/* <div className="resultview_mainbox"> */}
                       <div className="resultfirst_half">
                         <div className="resultname_child">
                           {/* <div className="resultfirst_div"> */}
                              ...
                              <div className="labdate-div">
                                <Upload {...props} style={{width:"100%"}} fileList={this.state.fileList}>
                                        ...
                                        <span className="myimage_upload">Blood Report.Pdf</span>
                                      {/* <Button className="upload_buttoninside" style={{textTransform:"none"}}
                                       onClick={this.handleChange}>Browse</Button> */}
                            
                                                            <Button  type="primary" className="pending_browse_btn">
                                         Browse
                            </Button>
                      ...
                      <div className="resultsecond_half">
                        ...
                        <div className="user_buttons_container">
                            ...
                            <Button variant="contained" className="cancel_button" onClick={()=>this.props.closemodal(false)}>Cancel</Button>
                       
                        <div className="cancel_submit_button">
                            <Button type="primary" variant="contained" className="Upload_button" >Submit</Button>
                            </div>
